...
public:
  ...
  // FІXΜЕ: override the useless getter in the base class
  char getCharacter() const override { return character; }
  // FІXΜЕ: this node is a leaf, so override the isLeaf method
...
public:
  ...
  // FІXΜЕ: override the useless getters from the base class
  HTreeNode* getLeft() const override { return left; }
  HTreeNode* getRight() const override { return right; }
  // FІXΜЕ: implement the destructor
